...
app.post('/api/contact', async (req, res) => {
  ...
  // Respond immediately to client to prevent form button hanging
  res.json({
    success: true,
    message: 'Inquiry received successfully. Confirmation sent.',
    leadId: newLead.id
  });

  // 2. Email Notifications (Dispatched Asynchronously)
  (async () => {
    try {
